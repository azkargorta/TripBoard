  ...
  const modeInstructions: Record<TripAiMode, string> = {
    ...
    planning:
      [
        ...
        "- Usa 2-5 items por día (calidad > cantidad). En viajes de más de 8 días, prioriza 2-4 items por día salvo que el usuario pida explícitamente más densidad.",
        "- CRÍTICO (límite servidor): el bloque TRIPBOARD_ITINERARY debe incluir como máximo 10 días distintos (day 1…10 de la secuencia que propongas). Si el viaje debe durar más días, aquí solo entregas la primera tanda; en el texto explica que puede enviar un segundo mensaje del estilo «continúa el itinerario desde el día 11» (o el número que toque) para la siguiente tanda, sin repetir días ya cubiertos en JSON.",
